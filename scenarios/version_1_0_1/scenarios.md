...
Изменения:
+ Регистрация. Добавление пунктов 3 и 3.1
...
|3. Пользователь переходит по ссылке в письме|3.Система считывает e-mail и отправляет на почту письмо с ссылкой для смены пароля|

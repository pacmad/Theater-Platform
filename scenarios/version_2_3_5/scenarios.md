...
|5. Пользователь видит кнопку цены. Нажав на нее открывается блок-окно с селектором ценового диапазона. Пользователь может перемещать левый ползунок. Справа от селектора отображается ценовой диапазон максимальной цены (до max).|5.Система отображает кнопку цены. Нажав на нее, система открывает блок-окно с селектором ценового диапазона, ползунком и справа отображает ценовой диапазон максимальной цены (до max).|
|*5.1 При изменении положения правого ползунка, значение максимальной цены изменяется.*|*5.1 При изменении положения правого ползунка, система изменяет значение максимальной цены.*|

...
### Блок "Афиша" изменено под новую версию
### Блок "Театры" изменено под новую версию
...
|*4.1 Если пользователь не авторизован, то, после нажатия на индикатор "Избранное", пользователь видит модальное окно с текстом "Для добавления спектакля в избранное, авторизуйтесь в системе."*|*4.1 Если пользователь не авторизован, то, система не добавляет спектакль в избранное. Открывает модальное окно с текстом "Для добавления спектакля в избранное, авторизуйтесь в системе."*|
...
|-------------------------------------------------|-------------------------------|
|Предусловие: Пользователь на странице блока "Афиша"|Предусловие: Открыта страница блока "Афиша"|
|1. Пользователь видит кнопку календаря, поле для даты и кнопку "Сброс". Нажав на календарь открывается блок-окно. Пользователь видит: кнопки для быстрого выбора - "Сегодня", "Завтра", "На этой неделе", "На следующей неделе", "В этом месяце", календарь текущего и следующего месяца.|1. Система отображает кнопку календаря, поле для даты и кнопку "Сброс". Нажав на календарь система открывает блок-окно. Система отображает: кнопки для быстрого выбора - "Сегодня", "Завтра", "На этой неделе", "На следующей неделе", "В этом месяце", календарь текущего и следующего месяца.|
...
|*7.1 Если пользователь не авторизован, то, после нажатия на индикатор "Избранное", пользователь видит модальное окно с текстом "Для добавления "спектакля_1" в избранное, авторизуйтесь в системе."*|*7.1 Если пользователь не авторизован, то, система не добавляет спектакль в избранное. Открывает модальное окно с текстом "Для добавления "спектакля_1" в избранное, авторизуйтесь в системе."*|

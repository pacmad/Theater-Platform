...
##### Блок "Главная страница" в разработке
##### Блок "личный кабинет" остались отзывы
...
|2. Пользователь видит остортированный по дате и времени оплаты список билетов. |2. Система автоматически сортирует билеты по дате в обратном порядке. и отображает статус билета справа.|
...
|Пользователь види информацию о театре||

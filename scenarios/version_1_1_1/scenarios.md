...
|*1.1 Если уведомления нет, то в окне текст "Нет уведомлений"*||
|2. Пользователь видит одно уведомление *текст уведомлений, где есть слово спектакль_1*||
|3. Пользователь может переходить на страницу спектакля кликнув на него||
|||

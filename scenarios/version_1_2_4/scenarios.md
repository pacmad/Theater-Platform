...
|*3.1 Если пользователь не авторизован, то на странице подтверждения оплаты он видит: фото, название спектакля, театра, день недели, дату и время, выбранные билеты (ряд, место), итоговую сумму, **поле "Имя","Фамилия"** и кнопку "Оплатить".*|*3.1 Если пользователь не авторизован, то на странице подтверждения оплаты система отображает: фото, название спектакля, театра, день недели, дату и время, выбранные билеты (ряд, место), итоговую сумму, **поле "Имя","Фамилия"** и кнопку "Оплатить".*|

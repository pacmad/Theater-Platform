...
+ вынесла отдельно сценарий по слайдеру, убрала из слайдера видео. дополнила сценарий.
+ определено время слайдера - 5 секунд
+ изменила название некоторых окон.
+ количество строк, карточек заменила на N
#### Блок "Личный кабинет"
+ в избранном прописала составляющие карточки
+ добавила цвет кнопок в моих покупках
+ количество строк, карточек заменила на N

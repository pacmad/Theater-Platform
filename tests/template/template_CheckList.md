...
## 1 вариант - взять толь перенос строки из html (минус - в редакторе придётся писать встроку, перенос сработает только при просмотре)
...
## 2 Вариант с Typora https://typora.io/
...
## 3 вариант - делать таблицы в html (минус - слишком много html)

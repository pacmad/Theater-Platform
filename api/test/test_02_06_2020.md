...
6. [Get Theater](#GetTheater)  
 ...
 [Add Spectacle](#AddTheater)  
 [Get Spectacles](#GetTheaters)  
 [Get Spectacle](#GetTheater)  
 [Delete Spectacle](#DeleteTheater)
...
# Add Spectacle<a name="AddTheater"></a>
[<-- Вернуться к списку](#Ссылки)
### Предусловия группы тестов
...
```
# Get Spectacles<a name="GetTheaters"></a>
[<-- Вернуться к списку](#Ссылки)
### Предусловия группы тестов
...
```
# Get Spectacle<a name="GetTheater"></a>
[<-- Вернуться к списку](#Ссылки)  
...
# Delete Spectacle<a name="DeleteTheater"></a>
[<-- Вернуться к списку](#Ссылки)  

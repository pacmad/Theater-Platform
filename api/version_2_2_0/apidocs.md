...
>*updates*:
>1. К payload регистрации добавлены имя и отчество, а также атрибут is_admin
>2. К payload авторизации в ответе, соответственно, добавлены имя и отчество + атрибут is_admin

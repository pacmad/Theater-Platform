...
>*updates*:
>1. Добавлены новые атрибуты в USER.
>2. Изменены API social networks.
>3. Добавлены новые API - 27, 28.
>4. Добавлены новое API - 51.
...
27. [Get Social Networks By Theater ID](#get-social-network-by-theater-id)
28. [Get All Social Networks](#get-all-social-networks)
29. [Delete Social Network](#delete-social-social) + ***
30. [Add Hall](#add-hall) +
31. [Update Hall](#update-hall) +
32. [Get Hall](#get-hall) + 
33. [Get Theater Halls](#get-theater-halls)
34. [Delete Hall](#delete-hall) +
35. [Add Seats](#add-seats)
36. [Get Hall Seats](#get-hall-seats)
37. [Delete Seats](#delete-seats)
38. [Add Tickets](#add-tickets)
39. [Get Event Tickets](#get-event-tickets)
40. [Get Event Ticket](#get-event-ticket)
41. [Update Event Tickets](#update-event-tickets)
42. [Delete Tickets](#delete-tickets)
43. [Tickets Purchase](#tickets-purchase)
44. [Upload Theater Logo](#upload-theater-logo) +
45. [Upload Theater Preview](#upload-theater-logo) +
46. [Upload Spectacle Poster](#upload-spectacle-poster) +
47. [Upload Spectacle Preview](#upload-spectacle-preview) +
48. [Upload Spectacle Slider Poster](#upload-spectacle-sliderposter) +
49. [Upload Theater Photo](#upload-theater-photo) +
50. [Upload Hall Scheme](#upload-hall-scheme) +
51. [Get User Info by Token](#get-user-info-by-token) +
...
## Get Social Networks By Theater ID
...
|----------------	|-------------------	|
| request method 	| GET |
| route          	| BASE_URL/socialnetworks?theater_id={theater_id}|
| error types    	| SocialNetworkNotFound |

#### RESPONSE DATA [SUCCESS]

>*Note*: 1) Возвращаются социальная сеть c theater_id == theater_id.

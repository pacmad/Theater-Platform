...
|Название|Обязательно|Ограничения|Формат|
|--------|-----------|-----------|------|
|Название|да|Может содержать только буквы кириллицы и латиницы обоих регистров, арабские цифры (0-9), набор допустимых специальных символов: !@#$%^&*.*,:;-"()/. Может содержать пробелы. Ограничения по символам: min - 2, max - 200.|строковый|
|Описание|да|Может содержать только буквы кириллицы и латиницы обоих регистров, арабские цифры (0-9), набор допустимых специальных символов: !@#$%^&*.*,:;-"()/. Может содержать пробелы. Ограничения по символам: min - 2, max - 2000|строковый|
|Рейтинг|нет|Целые и дробные числа. Два чила после запятой: min - 0.00, max - 5.00.|числовой|
|Длительность|нет|Целые числа: min - 0, max - 18000000 (300 минут). Может содержать пробелы.|числовой|
...
|Название|Обязательно|Ограничения|Формат|
|--------|-----------|-----------|------|
|Название|да|Может содержать только буквы кириллицы и латиницы обоих регистров, арабские цифры (0-9). Может содержать пробелы. Ограничения по символам: min - 2, max - 200|строковый|
|Описание|да|Может содержать только буквы кириллицы и латиницы обоих регистров, арабские цифры (0-9), набор допустимых специальных символов: !@#$%^&*.*,:;-"()/. Может содержать пробелы. Ограничения по символам: min - 2, max - 2000|строковый|
|Адрес|да|Может содержать только буквы кириллицы и латиницы обоих регистров, арабские цифры (0-9), набор допустимых специальных символов:.,()/. Может содержать пробелы. Ограничения по символам: min - 2, max - 127|строковый|
